...
const PdfTranscriptService_1 = require("./services/PdfTranscriptService");
const EmailNotificationService_1 = require("./services/EmailNotificationService");
const WhatsappNotificationService_1 = require("./services/WhatsappNotificationService");
console.log("╔══════════════════════════════════════════════════════════╗");
...
const transcriptService = new TranscriptService_1.TranscriptService();
const pdfTranscriptService = new PdfTranscriptService_1.PdfTranscriptService();
// 3. Inisialisasi Notification Services
const notificationServices = [
    new EmailNotificationService_1.EmailNotificationService(),
    new WhatsappNotificationService_1.WhatsappNotificationService(),
];
console.log("-".repeat(60));
console.log("1. MEMBUAT DATA MAHASISWA (Create)");
console.log("-".repeat(60));
const student1 = studentService.createStudent("24.01.5148", "Rafif Labied Alekhan", "rafiflabiedalekhan@amikom.ac.id", "081234567890", "Teknik Informatika");
const student2 = studentService.createStudent("24.01.5149", "Andi Wicaksono", "andiwicaksono@amikom.ac.id", "082345678901", "Teknik Informatika");
...
notificationServices.forEach((service) => {
    ...
    const recipient = service.getType() === "Email" ? student1.email : student1.phone;
